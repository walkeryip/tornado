...
--
-- Host: localhost
-- Generation Time: Dec 09, 2012 at 11:04 PM
...
--
-- Database: `domainnotifier`
--
CREATE DATABASE `domainnotifier` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `domainnotifier`;
...
-- Database: `giftonce`
--
CREATE DATABASE `giftonce` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `giftonce`;
--
-- Database: `girtonce`
--
CREATE DATABASE `girtonce` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `girtonce`;
--
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci AUTO_INCREMENT=615 ;
